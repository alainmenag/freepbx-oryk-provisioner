...
class FileRepo extends Repo
{
	 ...
	 *
	 * Under the Asterisk spool rather than anywhere beneath the web root: these
	 * are handed out by the endpoint reading them, never by Apache finding them.
	 *
	 ...
	 * served under, which can be renamed and repeats across profiles. An integer
	 * cast is a path that cannot climb out of its directory, and it means a file
	 * can be found and removed by id alone when its row is being deleted.
	 *
	 ...
	 *
	 * Called at install and again before every upload: the spool is not a place
